...
function ProgressDonut({ assignmentProgress }: { assignmentProgress: AssignmentProgress }) {
  ...
  return (
    <div className="w-full">
      <Chart options={donutChartData.options} series={donutChartData.series} type="radialBar" />
    </div>
  );
}
